...
namespace urt_presentaciones.Repositorios
{
    ...
    public class EstantesPrueba
    {
        ...
        public bool Listar()
        {
            this.lista = this.iConexion!.Estantes!.ToList();
            return lista.Count > 0;
        }
        public bool Guardar()
        {
            this.entidad = EntidadesNucleo.estantes()!;
            this.iConexion!.Estantes!.Add(this.entidad);
        ...
        public bool Modificar()
        {
            ...
            var entry = this.iConexion!.Entry<Estantes>(this.entidad!);
        ...
        public bool Borrar()
        {
            this.iConexion!.Estantes!.Remove(this.entidad!);
            this.iConexion!.SaveChanges();
            return true;
        }
    }
