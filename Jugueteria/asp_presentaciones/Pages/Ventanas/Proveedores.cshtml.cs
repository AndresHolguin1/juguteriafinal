...
namespace asp_presentaciones.Pages.Ventanas
{
    ...
    {
        private IProoveedoresPresentacion? iPresentacion = null;
        public ProveedoresModel(IProoveedoresPresentacion iPresentacion) { try { this.iPresentacion = iPresentacion; Filtro = new Proveedores(); } catch (Exception ex) { LogConversor.Log(ex, ViewData!); } }
        ...
        {
            ViewData["BodyClass"] = "proveedores-background";
