...
namespace asp_presentaciones.Pages.Ventanas
{
    public class UsuariosModel : PageModel
    {
        ...
        public UsuariosModel(IUsuariosPresentacion iPresentacion) { try { this.iPresentacion = iPresentacion; Filtro = new Usuarios(); } catch (Exception ex) { LogConversor.Log(ex, ViewData!); } }
        ...
        {
            ViewData["BodyClass"] = "usuarios-background";
