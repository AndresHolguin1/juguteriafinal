...
{
    public class JuguetesModel : PageModel
    {
        private IJuguetesPresentacion? iPresentacion = null;
        private IEstantesPresentacion? iEstantesPresentacion = null;


        public JuguetesModel(IJuguetesPresentacion iJuguetesPresentacion, IEstantesPresentacion iEstantePresentacion)
        {
            try
            {
                this.iPresentacion = iJuguetesPresentacion;
        ...
        [BindProperty] public Juguetes? Actual { get; set; }
        [BindProperty] public Juguetes? Filtro { get; set; }
        [BindProperty] public List<Juguetes>? Lista { get; set; }
        [BindProperty] public List<Estantes>? estante { get; set; }
        public async Task OnGetAsync()
        {
            ViewData["BodyClass"] = "juguetes-background";
        ...
        private void CargarCombox()
        {
            try
            {
                var task = this.iEstantesPresentacion!.Listar();
                task.Wait();
                estante = task.Result;
            }
            catch (Exception ex)
